...
public enum RestingHeartRateLab {
  ...
  public static func sanitizedReport(
    ...
    var lines = [
      ...
      "RHR Lab HealthKit writes: disabled",
      "",
      "Decoded values",
      "- Eight reported RHR: \(formatBPM(night.discoveredRestingHeartRateBPM))",
      "- Eight HR average field (meaning unverified): \(formatBPM(night.averageHeartRateBPM))",
      "- Eight HRV label: RMSSD",
      "- Eight HRV: \(format(night.reportedHRVMilliseconds, suffix: " ms"))",
      "- Nightly respiratory rate: \(format(night.averageRespiratoryRate, suffix: " /min"))",
      "",
      "Heart-rate series",
